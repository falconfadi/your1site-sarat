...
@section('title') Elements @endsection
@push('styles')
<link rel="stylesheet" type="text/css" href="{{asset('website/css/elements_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('website/css/elements_responsive.css')}}">
@endpush
@section('content')
					...
					<div class="row">
						...
						<div class="col-lg-3 milestone_col">
							<div class="milestone text-center">
								<div class="milestone_icon"><img src="{{asset('website/images/milestone_1.svg')}}" alt="https://www.flaticon.com/authors/zlatko-najdenovski"></div>
						...
						<div class="col-lg-3 milestone_col">
							<div class="milestone text-center">
								<div class="milestone_icon"><img src="{{asset('website/images/milestone_2.svg')}}" alt="https://www.flaticon.com/authors/zlatko-najdenovski"></div>
						...
						<div class="col-lg-3 milestone_col">
							<div class="milestone text-center">
								<div class="milestone_icon"><img src="{{asset('website/images/milestone_3.svg')}}" alt="https://www.flaticon.com/authors/zlatko-najdenovski"></div>
						...
						<div class="col-lg-3 milestone_col">
							<div class="milestone text-center">
								<div class="milestone_icon"><img src="{{asset('website/images/milestone_4.svg')}}" alt="https://www.flaticon.com/authors/zlatko-najdenovski"></div>
...
<script src="{{asset('website/plugins/progressbar/progressbar.min.js')}}"></script>
