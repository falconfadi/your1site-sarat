...
@push('styles')
<link rel="stylesheet" type="text/css" href="{{asset('website/css/news_post_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('website/css/news_post_responsive.css')}}">
@endpush
@section('content')
					...
					<div class="news_post_container">
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{asset('website/images/news_1.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
						...
						<ul class="comments_list">
								...
								<div class="comment_container d-flex flex-row">
									<div>
										<div class="comment_image">
											<img src="{{asset('website/images/comment_1.jpg')}}" alt="">
										</div>
									</div>
							...
							<li class="comment">
								<div class="comment_container d-flex flex-row">
									<div>
										<div class="comment_image">
											<img src="{{asset('website/images/comment_2.jpg')}}" alt="">
										</div>
									</div>
									<div class="comment_content">
										<div class="comment_meta">
							...
							<div class="latest_posts">
								...
								<div class="latest_post">
									<div class="latest_post_image">
										<img src="{{asset('website/images/latest_1.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
									</div>
								...
								<div class="latest_post">
									<div class="latest_post_image">
										<img src="{{asset('website/images/latest_2.jpg')}}" alt="https://unsplash.com/@erothermel">
									</div>
									<div class="latest_post_title"><a href="news_post.html">Why do you need a qualification?</a></div>
									<div class="latest_post_meta">
										<span class="latest_post_author"><a href="#">By Christian Smith</a></span>
								...
								<div class="latest_post">
									<div class="latest_post_image">
										<img src="{{asset('website/images/latest_3.jpg')}}" alt="https://unsplash.com/@element5digital">
									</div>
									<div class="latest_post_title"><a href="news_post.html">Why do you need a qualification?</a></div>
									<div class="latest_post_meta">
										<span class="latest_post_author"><a href="#">By Christian Smith</a></span>
